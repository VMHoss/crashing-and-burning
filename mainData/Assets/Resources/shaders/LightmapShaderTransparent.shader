Shader "XformShaders/UnlitLightmapFogTransparent" {
Properties {
...
{
  lowp vec4 tmpvar_1;
  tmpvar_1 = ((texture2D (_MainTex, xlv_TEXCOORD0) * texture2D (_LightTex, xlv_TEXCOORD1)) * _MainColor);
...
lowp vec4 frag( in Input IN ) {
    ...
    lowp vec4 cl = texture( _LightTex, IN.uv2);
    #line 328
